...
> ⚠️ **早期历史文档**：本文写于项目启动期（2026-07，Dify + Python demo → Spring AI 迁移阶段）。
> 其中"现有系统分析"（`custom-agent/` 目录、拼多多客服、Dify Chatflow）等描述已不适用于当前代码库；
> 模糊语义、多问题拆分、AI 幻觉、动态配置等章节的**设计思路**仍有参考价值，
> 但**实现现状以 `README.md` 与 `docs/智能汽车销售客服系统-整体详细设计.md` 为准**。
